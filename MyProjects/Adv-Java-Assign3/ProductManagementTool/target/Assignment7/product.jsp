...
<body>
  <nav class="navbar navbar-light">
    <div class="container-fluid">
      <span class="navbar-text"> Product Management Tools </span>
      <span id="user-show"> hey <%= session.getAttribute("username").toString() %></span>
         ...
         <tbody>
			...
			%>
      		<tr>
				...
				<td class="table-data" style="text-align: center; vertical-align: middle;">
					<form action="Delete" method="post">
        				<button class="btn btn-primary" type="submit" name="submit" value="<%=iter.getProductId()%>">
          					Delete
        				</button>
     				</form>
				</td>
